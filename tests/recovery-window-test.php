...
rwSame('2026-08-09 07:27:57',SvAmazonRecoveryWindow::effectiveDeadlineAt($short,'SELLER_SUPPORT_OPEN')?->format('Y-m-d H:i:s'),'Seller Support must keep the D+90 recovery deadline instead of inheriting an expired appeal deadline.');
$late=array_replace($case,['appeal_deadline_at'=>'2026-12-01T00:00:00Z']);
rwSame('2026-08-09 07:27:57',SvAmazonRecoveryWindow::effectiveDeadlineAt($late,'SAFE_T_APPEAL')?->format('Y-m-d H:i:s'),'Explicit appeal deadline must not extend recovery beyond D+90.');
