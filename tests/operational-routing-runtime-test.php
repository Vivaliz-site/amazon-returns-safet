...
foreach(['SvAmazonFinancialRevalidation::sourceEvent(','SvAmazonFinancialCheckEvidence::reconciled(','financial_checks_requested','next_action_at'] as $needle){if(!str_contains($daemon,$needle))$errors[]='Runtime missing '.$needle;}
