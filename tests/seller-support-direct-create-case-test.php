...
foreach(['async function fillDirectSupportCaseDetails','async function waitForDirectSupportCaseDetails','Provide details about the order reimbursement error','async clickFrameButtonTrustedByText','Create a case','SUPPORT_CASE_OPENED_DIRECTLY'] as $needle){
