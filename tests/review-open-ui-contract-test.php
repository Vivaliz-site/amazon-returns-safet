...
$checks = [
    str_contains($index, '/admin/amazon-returns/assets/review-focus.js?v='),
...
if (in_array(false, $checks, true)) {
    throw new RuntimeException('Opening a review must provide immediate visible feedback, use a versioned asset, and move focus to the review panel or error.');
}
