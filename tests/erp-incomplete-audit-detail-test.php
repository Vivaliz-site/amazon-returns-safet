...
eiadAssert(str_contains($repo,"status NOT IN ('RETURN_CREATED_WAITING_INVOICE','RETURN_INVOICE_EXISTS')"),'Incomplete audit must use the same completion boundary as countIncomplete().');
