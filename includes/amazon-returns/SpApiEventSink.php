    ...
    public static function persistReturnsReportRow(
        ...
        $target->events->append([
            ...
            'payload'=>[
                ...
                'invoice_number'=>self::nullable($row['Invoice number'] ?? null),
                'amazon_rma_id'=>self::nullable($row['Amazon RMA ID'] ?? null),
                'merchant_rma_id'=>self::nullable($row['Merchant RMA ID'] ?? null),
                'tracking_id'=>self::nullable($row['Tracking ID'] ?? null),
                'return_carrier'=>self::nullable($row['Return carrier'] ?? null),
                'return_request_date'=>self::nullable($row['Return request date'] ?? null),
                'return_request_status'=>self::nullable($row['Return request status'] ?? null),
                'return_delivery_date'=>self::nullable($row['Return delivery date'] ?? null),
                'safe_t_claim_id'=>self::nullable($row['SafeT claim id'] ?? null),
            ],
            'evidence_sha256'=>null,
        ]);
