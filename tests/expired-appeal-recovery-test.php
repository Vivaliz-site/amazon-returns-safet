...
if(($lateDecision['action']??null)!=='SAFE_T_APPEAL')$errors[]='Expired late-filing denial must still get one automatic recovery appeal attempt when no reimbursement exists. got='.json_encode($lateDecision);
...
$paidTimeline=[['id'=>5,'case_id'=>511,'event_type'=>'SAFE_T_STATUS_OBSERVED','source'=>'SELLER_CENTRAL','occurred_at'=>'2026-09-07 04:48:20','payload'=>['safe_t_id'=>'54298-92555-1188848','claim_status'=>'DENIED','appeal_submitted'=>false,'decision_text'=>'A Amazon determinou que o item não foi devolvido e emitiu o reembolso ao vendedor.','appeal_deadline_at'=>'2026-08-05 08:17:00']],['id'=>6,'case_id'=>511,'event_type'=>'SAFE_T_REIMBURSEMENT_OBSERVED','source'=>'SP_API_FINANCES_V0','occurred_at'=>'2026-07-10 00:00:00','payload'=>['safe_t_claim_id'=>'54298-92555-1188848','reimbursed_amount'=>['amount'=>'49.00','currency'=>'BRL']]]];
