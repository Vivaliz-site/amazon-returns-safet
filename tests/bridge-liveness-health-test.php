...
$ok=SvAmazonBridgeLiveness::evaluate($fresh,$now,true);
...
$staleResult=SvAmazonBridgeLiveness::evaluate($stale,$now,true);
...
$failedResult=SvAmazonBridgeLiveness::evaluate($failed,$now,true);
...
$missing=SvAmazonBridgeLiveness::evaluate(null,$now,true);
