...
foreach(['STANDARD','FBA_ONSITE','DELIVERY_BY_AMAZON'] as $program){
    ...
    foreach(['2026-06-16T12:00:00Z'=>false,'2026-06-17T11:59:59Z'=>false,'2026-06-17T09:00:00-03:00'=>true] as $at=>$expected){
        ...
        d45eq('2026-06-17 12:00:00',$result['eligibility_at'],$program.' operational date');
    }
...
d45eq(10,SvAmazonReturnPolicyEngine::evaluate($case,new DateTimeImmutable('2026-06-17T12:00:00Z'))['policy_version_id'],'Numeric policy revision 10 after 9');
