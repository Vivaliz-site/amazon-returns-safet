...
function renderOperationalEvidence(c,timeline){
  ...
  if(c.erp_return?.invoice_number)details.append(text('p',`Nota fiscal de devolução: ${c.erp_return.invoice_number}.`));
