...
srAssert(str_contains($calls,'release amazon_returns_safet 7 11'),'Quiescence must release stale read-only leases before waiting.');
...
srAssert(str_contains($source,'INTERVAL 300 SECOND'),'Lease recovery must honor the outbox lease duration.');
