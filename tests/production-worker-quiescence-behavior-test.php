...
qbAssert(substr_count($events,'thaw amazon-returns-safet.service')===1,'Race detection must thaw the main worker once.');
qbAssert(substr_count($events,'thaw amazon-returns-seller-central-browser.service')===1,'Race detection must thaw the browser worker once.');
qbAssert(substr_count($events,'stop amazon-returns-safet.service')===1,'Confirmed idle main worker must stop once.');
qbAssert(substr_count($events,'stop amazon-returns-seller-central-browser.service')===1,'Confirmed idle browser worker must stop once.');
