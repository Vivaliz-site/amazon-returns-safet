...
An existing claim is resumed, not submitted as a new duplicate. A valid appeal window is required; expired appeals route to detailed review instead of being resubmitted blindly.
