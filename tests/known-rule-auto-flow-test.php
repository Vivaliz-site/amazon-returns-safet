...
$learnedSupport=$engine->guardLearnedEffect(['action'=>'SELLER_SUPPORT_OPEN','parameters'=>['date_binding'=>'NONE']],$appeal,[],['eligible'=>true],$now);ksame('SELLER_SUPPORT_OPEN',$learnedSupport['action'],'approved learned support route');ksame('GENERAL_ORDER_SUPPORT',$learnedSupport['support_route']??null,'learned support escalation must use general route');
