...
tsAssert(count($statements) === 12, 'Schema must contain four control-plane and eight data-plane tables.');
tsAssert(substr_count($ddl, 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci') === 12, 'Every table must use InnoDB and utf8mb4.');
